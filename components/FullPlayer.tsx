...
const FullPlayer: React.FC<FullPlayerProps> = ({
  ...
  return (
    <>
    <div className={`fixed inset-0 z-[60] flex flex-col bg-[#f8fafc] transition-transform duration-500 ease-[cubic-bezier(0.32,0.72,0,1)] ${isExpanded ? 'translate-y-0' : 'translate-y-[110%]'}`}>
